...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { fecha_nacimiento: @actor.fecha_nacimiento, nombre: @actor.nombre, nombre_real: @actor.nombre_real } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { fecha_nacimiento: @actor.fecha_nacimiento, nombre: @actor.nombre, nombre_real: @actor.nombre_real } }
