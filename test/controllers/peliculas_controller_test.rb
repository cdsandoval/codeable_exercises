...
class PeliculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post peliculas_url, params: { pelicula: { categoria: @pelicula.categoria, titulo: @pelicula.titulo } }
    end
  ...
  test "should update pelicula" do
    patch pelicula_url(@pelicula), params: { pelicula: { categoria: @pelicula.categoria, titulo: @pelicula.titulo } }
